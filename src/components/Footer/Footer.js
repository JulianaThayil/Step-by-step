  ...
  return (
    ...
    <div className={classes.footer}>
      <div className={classes.footerContent}>
        <div className={classes.footerSectionAbout}>
          <h1 className={classes.logoText}>
            <span>STEP</span>-BY-STEP
          </h1>
          <p>
            This is an easy recipe sharing website which is made for those who
            really love sharing their work and skill baked right from their
            kitchens. Join us and start chopping into the world of STEP-BY-STEP.
          </p>
        </div>
        ...
        <div className={classes.footerSectionContact}>
          <h1 className={classes.contact}>Contact us at:</h1>
          <br />
          <span>
      ...
      <div className={classes.footerBottom}>
        &copy; Copyrights@2020 | Made with ❤ in Goa.
      </div>
    </div>
